...
export async function resolveProgrammaticItinerary(slug) {
  ...
  if (duration) {
    seoTitle = `Roteiro Completo de ${duration} Dias em ${destination.name} | Planejamento Diário | 2GO Roteiros`;
    ...
    seoTitle = `Roteiro ${styleLabels[style] || style} em ${destination.name} | Rota Inteligente | 2GO Roteiros`;
    ...
    seoTitle = `Roteiro Especial de Viagem para ${destination.name} | 2GO Roteiros`;
